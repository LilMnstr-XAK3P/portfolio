  ...
  const linkClass = ({ isActive }: { isActive: boolean }) =>
    `whitespace-nowrap rounded-full px-3 py-1.5 text-sm font-medium transition-colors ${
      isActive
        ...
        : 'text-stone-600 hover:bg-stone-50 hover:text-stone-900 dark:text-stone-300 dark:hover:bg-stone-800/60 dark:hover:text-white'
    }`;

  return (
    <header className="no-print sticky top-0 z-40 border-b border-stone-200 bg-stone-50/90 backdrop-blur dark:border-stone-800 dark:bg-stone-950/90">
      <a
        href="#main-content"
      ...
      {open && (
        <nav
          ...
          className="border-t border-stone-200 bg-stone-50 px-4 pb-4 pt-2 dark:border-stone-800 dark:bg-stone-950 lg:hidden"
        >
