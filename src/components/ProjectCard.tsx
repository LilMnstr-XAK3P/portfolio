  ...
  return (
    <article className="card flex h-full flex-col p-5">
      <div className="flex items-start justify-between gap-2">
        <h3 className="font-semibold text-stone-900 dark:text-white">{project.title}</h3>
        <span
      ...
      <p className="mt-2 flex-1 text-sm leading-relaxed text-stone-700 dark:text-stone-300">
        {project.description}
      </p>

      {project.outcomes && project.outcomes.length > 0 && (
        <ul className="mt-3 list-inside list-disc text-sm text-stone-600 dark:text-stone-400">
      ...
      <div className="mt-4 flex flex-wrap items-center gap-3 border-t border-stone-100 pt-3 text-sm dark:border-stone-800">
